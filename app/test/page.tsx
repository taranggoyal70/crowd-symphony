		...
		<div className="min-h-screen bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center p-4">
			<div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
				...
				<div className="bg-green-100 border-2 border-green-500 rounded-lg p-4 mb-6">
					<p className="text-green-800 font-semibold">✓ App: Connected</p>
					<p className="text-green-800 font-semibold">✓ Vercel: Ready</p>
					<p className="text-green-800 font-semibold">
						✓ Realtime: /api/realtime
					</p>
				</div>
				<p className="text-sm text-gray-500">
					If you see this page, the deployed app routes are working.
				</p>
				<div className="mt-6">
					<a
						href="/"
