...
function AudienceContent() {
	...
	const startWaveEffect = () => {
		...
		let time = 0;
		const animate = () => {
			if (!pannerNodeRef.current || !audioContextRef.current || !isPlaying)
				return;
	...
	const sectionGlow =
		section === "left" ? "shadow-green-500/50" : "shadow-purple-500/50";
	...
	return (
		...
		>
			...
			{bassBoost && (
				...
				>
					<div
						className={`absolute inset-0 bg-gradient-to-br ${sectionColor} opacity-20`}
					/>
				</motion.div>
			)}
			...
			<div className="max-w-md w-full relative z-10">
				...
				<div className="text-center mb-8">
					...
					>
						{bassBoost ? (
							...
							<Music
								className={`w-20 h-20 ${section === "left" ? "text-green-400" : "text-purple-400"}`}
							/>
						)}
					</motion.div>
				...
				{/* Main Player */}
				<div
					className={`bg-gradient-to-br ${sectionColor} p-1 rounded-3xl shadow-2xl ${sectionGlow} shadow-2xl`}
				>
						...
						<div className="mb-8 flex justify-center">
							<div className="relative">
								...
								>
									{/* Wand Stick */}
									<div
										className={`w-4 h-48 bg-gradient-to-b from-amber-600 to-amber-800 rounded-full mx-auto relative shadow-lg`}
									>
										{/* Wand Handle Grip */}
												...
												<defs>
													...
													>
														<stop
															offset="0%"
															stopColor={
																section === "left" ? "#10b981" : "#a855f7"
															}
														/>
														<stop
															offset="100%"
															stopColor={
																section === "left" ? "#34d399" : "#ec4899"
															}
														/>
													</linearGradient>
												</defs>
						...
						<div className="mt-6 space-y-3">
							<div className="p-4 bg-gray-900 rounded-xl border border-gray-800">
								<div className="flex items-center justify-between text-sm">
									...
									<span
										className={`font-bold ${bassBoost ? "text-yellow-400 animate-pulse" : "text-white"}`}
									>
										{bassBoost
											? "🔥 BASS DROP!"
											: isPlaying
